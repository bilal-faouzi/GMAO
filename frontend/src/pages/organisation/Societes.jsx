...
import { getSocietes, createSociete, updateSociete, deleteSociete } from '@/services/organisationService'
...
export default function Societes() {
  ...
  const fields = [
    ...
    { name: 'raisonSociale', label: 'Raison Sociale', placeholder: 'GMAO Industries SA', required: true  },
  ...
  const rows = data.map(s => ({
    ...
    raisonSociale: <span className="font-medium text-white">{s.raisonSociale}</span>,
