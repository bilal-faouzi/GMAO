...
export default function CompteRenduOT() {
  ...
  return (
    <div className="p-6 text-white max-w-3xl">
      ...
      {/* Messages */}
      {erreur && (
        <div className="bg-red-500/20 border border-red-500/40 text-red-400 rounded-lg p-4 mb-4 text-sm">
          {erreur}
        </div>
      )}
      {succes && (
        <div className="bg-green-500/20 border border-green-500/40 text-green-400 rounded-lg p-4 mb-4 text-sm">
          {succes}
        </div>
      )}
      ...
      <form onSubmit={handleSubmitRapport} className="space-y-5">
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-5">
          ...
          <textarea
            ...
            onChange={(e) =>
              setRapport((r) => ({ ...r, descriptionTravail: e.target.value }))
            }
        ...
        <div className="bg-gray-800 rounded-xl border border-gray-700 p-5">
          ...
          <textarea
            ...
            onChange={(e) =>
              setRapport((r) => ({ ...r, solutionApportee: e.target.value }))
            }
            ...
            <label
              ...
              <div>
                ...
                <p className="text-xs text-green-400 mt-0.5">
                  L'équipement fonctionne normalement — prêt pour la clôture
                </p>
              </div>
            </label>
            ...
            <label
              ...
              <div>
                ...
                <p className="text-xs text-orange-400 mt-0.5">
                  Solution temporaire — l'équipement fonctionne partiellement,
