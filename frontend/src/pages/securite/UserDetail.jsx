...
function SectionCard({ icon: Icon, title, children, fullWidth }) {
  return (
    <div
      className="tbl-card"
      style={{
  ...
  return (
    <div className="page">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
        {/* Rôles */}
        <SectionCard icon={Shield} title="Rôles attribués">
          {roles.length === 0 ? (
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
        {/* Équipe */}
        <SectionCard icon={Users} title="Équipe">
          {activeTeam ? (
        ...
        <SectionCard icon={Building2} title="Appartenance organisationnelle">
          {primaryOrg ? (
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
        ...
        <div
          ...
          <div
            ...
            <div
              ...
              {/* TODO Phase 6 : appeler getOTByUser(userId) */}
              <span
                className="badge"
                style={{
                  background: "var(--status-blue-bg)",
        ...
        {/* Card 2 — Historique des Signalements */}
        <div
          className="tbl-card"
          style={{
            padding: 0,
          ...
          <div
            ...
            <div
              ...
              {/* TODO Phase 7 : appeler getDIByUser(userId) */}
              <span
                className="badge"
                style={{
                  background: "var(--status-orange-bg)",
