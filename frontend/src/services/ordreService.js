...
export const getDemande = (id) =>
    api.get(`/v1/ordres/demandes/${id}/`);

export const createDemande = (data) =>
    api.post('/v1/ordres/demandes/', data);
...
export const getOT = (id) =>
    api.get(`/v1/ordres/ots/${id}/`);

export const createOT = (data) =>
    api.post('/v1/ordres/ots/', data);

export const updateOT = (id, data) =>
    api.put(`/v1/ordres/ots/${id}/`, data);

export const deleteOT = (id) =>
    api.delete(`/v1/ordres/ots/${id}/`);

export const changerStatutOT = (id, statut, motif = '', typeCloture = '') =>
    api.post(`/v1/ordres/ots/${id}/changer_statut/`, { statut, motif, typeCloture });
...
export const ajouterCommentaire = (id, commentaire, estInterne = false) =>
    api.post(`/v1/ordres/ots/${id}/ajouter_commentaire/`, { commentaire, estInterne });

export const cloturerOT = (id, typeCloture = 'corrige', motif = '') =>
    api.post(`/v1/ordres/ots/${id}/cloturer/`, { typeCloture, motif });

export const getDashboardOT = () =>
    api.get('/v1/ordres/ots/dashboard/');
...
export const getCommentaires = (idOT, estInterne = null) => {
    const params = estInterne !== null ? `?idOrdreTravail=${idOT}&estInterne=${estInterne}` : `?idOrdreTravail=${idOT}`;
